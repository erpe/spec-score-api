...
describe "teammates/new" do
  before(:each) do
    ...
    assign( :teammate, stub_model(SpecScoreApi::Teammate, id: 1, user_id: 1, project_id: 2 ).as_new_record)
  end
  ...
  it "renders new teammate form" do
    ...
    assert_select "form[action=?][method=?]", spec_score_api.project_teammates_url(project_id: 2), "post" do
